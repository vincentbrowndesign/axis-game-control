...
- Current unit: identity -> physical presence -> history persistence.
...
- Stay in scope.
- Do not implement replay, clips, broadcasts, overlays, AI commentary, or Roboflow/CV until the current seam is stable.
