...
4. Axis Game-Ready Reality Marks Core — Local `/axis/lab` game-use experiment. Status: Build Now in lab only. Manual local session clock and Reality Marks only. No camera, mic, upload, CV, persistence, evidence, Data Asset runtime, or active `/axis` behavior.
