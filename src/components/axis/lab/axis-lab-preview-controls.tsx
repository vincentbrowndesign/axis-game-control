...
export type LabState = "empty" | "active" | "make-space" | "expanded";
...
export default function AxisLabPreviewControls({
  ...
  return (
    <div className={styles.controls}>
      ...
      <span className={styles.stateToggle} role="group" aria-label="Lab state">
        <span className={styles.stateToggleLabel} aria-hidden="true">Lab state</span>
        {LAB_STATES.map((s, i) => (
          <Fragment key={s.id}>
            {i > 0 && (
